<div>
    ...
    >
        ...
        <div x-data="{ filterOpen: false, statusOpen: false }" class="relative w-full">
            ...
            <div 
                x-show="filterOpen"
                @click.away="filterOpen = false; statusOpen = false"
            ...
            >
                ...
                <div class="w-full flex flex-col">
                    ...
                    <div class="w-full border-b border-[#b2b2b2] flex flex-col items-start" style="padding: 10px 20px;">
                        <div class="w-full flex items-center">
                            <h3 class="font-semibold text-[#0a0a0a]" style="font-size: 14px; line-height: 124%;">Filter Status</h3>
                        </div>
                    </div>
                    ...
                    <div class="w-full flex flex-col items-start" style="padding: 0px 20px; gap: 13px;">
                        <button 
                            type="button"
                            wire:click="toggleFilterStatus('diproses')"
                        ...
                        <button 
                            type="button"
                            wire:click="toggleFilterStatus('selesai')"
                ...
                <div class="w-full flex flex-col">
                    ...
                    <div class="w-full border-b border-[#b2b2b2] flex flex-col items-start" style="padding: 10px 20px;">
                        <div class="w-full flex items-center">
                            <h3 class="font-semibold text-[#0a0a0a]" style="font-size: 14px; line-height: 124%;">Urutkan</h3>
                        </div>
                    </div>
                    ...
                    <div class="w-full flex flex-col items-start" style="padding: 0px 20px; gap: 13px;">
                        ...
                        <button 
                            type="button"
                            wire:click="setSortBy('terpopuler')"
                            class="w-full flex items-center cursor-pointer transition-colors hover:bg-[#F5F5F5]"
                            style="height: 44px; border-radius: 8px; padding: 0px 12px; gap: 8px;"
                        >
