...
@else
    ...
    >
        ...
        >
            ...
            {{-- Sidebar Content --}}
            <div class="relative flex flex-col w-72 max-w-[80%] h-full bg-[#FAFAFA] border-r border-[#E0E0E0] font-['Inter','Roboto',sans-serif] text-[#424242] overflow-y-auto" style="padding: 24px 16px;">
                {{-- Close button --}}
                <button
                    @click="open = false"
