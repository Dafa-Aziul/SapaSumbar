<div>
    ...
    {{-- Modal Container --}}
    @if ($isOpen)
    <div x-data x-show="true" x-transition:enter="ease-out duration-300" x-transition:enter-start="opacity-0 scale-95"
        ...
        <div @click.stop
            ...
            <form wire:submit.prevent="submit" class="flex flex-col" style="gap: 20px;">
               ...
               focus:border-transparent text-sm resize-none" style="border-radius: 6px;"></textarea>
                ...
                <div class="flex justify-end gap-3 mt-2">
                    <button type="button" wire:click="closeModal"
                        class="h-10 px-4 rounded-md font-semibold text-sm transition-colors" style="
